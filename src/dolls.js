...
const threeStar = {
  ...
  smg: [
    ...
    { name: 'F1', time: '1:50:00', heavy: HeavySet1111 },
    ...
    { name: 'Z-62', time: '2:05:00', heavy: HeavySet1111 },
  ...
  ar: [
    ...
    { name: 'ARX-160', time: '3:15:00', heavy: HeavySet1111 },
  ...
  rf: [
    ...
    { name: 'OTs-44', time: '3:50:00', heavy: HeavySet4141 },
  ...
  sg: [
    { name: 'NS2000', time: '7:15:00', heavy: HeavySet6164 },
    ...
    { name: 'M1897', time: '7:30:00', heavy: HeavySet6164 }
  ]
}

const fourStar = {
  hg: [
    { name: 'Jericho', time: '49:00', standard: HGSet2 },
    { name: 'SAA', time: '50:00', standard: HGSet1 },
    { name: 'Gr Mk23', time: '50:00', standard: HGSet1 },
    { name: 'Spitfire', time: '52:00', standard: HGSet2 },
    { name: 'K5', time: '53:00', standard: HGSet2 },
  ...
  smg: [
    ...
    { name: 'Shipka', time: '2:18:00', standard: SMGSet2, heavy: HeavySet4411 },
    { name: 'PP-19-01', time: '2:18:00', standard: SMGSet2, heavy: HeavySet4411 },
    { name: 'MP5', time: '2:20:00', standard: SMGSet1, heavy: HeavySet1111 },
    { name: 'PP90', time: '2:20:00', standard: SMGSet2, heavy: HeavySet4411 }
  ],
  ar: [
    { name: 'Type56-1', time: '3:25:00', standard: ARSet1, heavy: HeavySet1111 },
    { name: 'XM8', time: '3:25:00', standard: ARSet1, heavy: HeavySet1111 },
    { name: 'SAR-21', time: '3:25:00', standard: ARSet1, heavy: HeavySet1111 },
    ...
    { name: 'Ribeyrolles', time: '3:40:00', standard: ARSet2, heavy: HeavySet1441 }
  ],
  rf: [
    { name: 'Mosin-Nagant', time: '4:10:00', standard: RFSet1, heavy: HeavySet3131 },
    { name: 'T-5000', time: '4:10:00', standard: RFSet2, heavy: HeavySet4141 },
    { name: 'SVD', time: '4:15:00', standard: RFSet2, heavy: HeavySet4141 },
    { name: 'SPR A3G', time: '4:15:00', standard: RFSet2, heavy: HeavySet4141, unsure: [0, 1] },
    { name: 'K31', time: '4:15:00', standard: RFSet2, heavy: HeavySet4141, unsure: [1, 1] },
    { name: 'PSG-1', time: '4:10:00', heavy: HeavySet4141 },
    { name: 'G28', time: '4:10:00', heavy: HeavySet4141 },
    ...
    { name: 'PzB 39', time: '4:30:00', heavy: HeavySet4141 }
  ],
  mg: [
    { name: 'M60', time: '6:10:00', standard: MGSet1, heavy: HeavySet4613 },
    { name: 'Type 80', time: '6:15:00', standard: MGSet2, heavy: HeavySet6613, unsure: [0, 1] },
    { name: 'Mk48', time: '6:20:00', standard: MGSet2, heavy: HeavySet6613 },
  ...
  sg: [
    { name: 'M1014', time: '7:14:00', heavy: HeavySet6164 },
    { name: 'M590', time: '7:40:00', heavy: HeavySet4163 },
    { name: 'SPAS-12', time: '7:40:00', heavy: HeavySet4163 },
    { name: 'M37', time: '7:45:00', heavy: HeavySet6164 },
    { name: 'Super-Shorty', time: '7:50:00', heavy: HeavySet6164 },
    { name: 'USAS-12', time: '7:55:00', heavy: HeavySet6164 }
  ]
}
...
const fiveStar = {
  hg: [
    ...
    { name: 'Px4 Storm', time: '1:04:00', standard: HGSet1 },
  ...
  smg: [
    { name: 'MP7', time: '2:18:00', standard: SMGSet2, heavy: HeavySet4411, unsure: [1, 1] },
    { name: 'Type 100', time: '2:19:00', standard: SMGSet2, heavy: HeavySet4411, unsure: [1, 1] },
    { name: 'Suomi', time: '2:25:00', standard: SMGSet2, heavy: HeavySet4411 },
    { name: 'C-MS', time: '2:28:00', standard: SMGSet2, HeavySet4411, unsure: [0, 1] },
    { name: 'P90', time: '2:29:00', standard: SMGSet2, heavy: HeavySet4411, unsure: [1, 1] },
  ...
  ar: [
    ...
    { name: 'Zas M21', time: '4:05:00', standard: ARSet2, heavy: HeavySet1441 },
    { name: 'Howa Type 64', time: '4:06:00', standard: ARSet2, heavy: HeavySet1441, unsure: [1, 1] },
    { name: 'AN-94', time: '4:09:00', standard: ARSet2, heavy: HeavySet1441 },
    { name: 'K11', time: '4:11:00', standard: ARSet2, heavy: HeavySet1441, unsure: [0, 1] },
    { name: 'AK-12', time: '4:12:00', standard: ARSet2, heavy: HeavySet1441 }
  ],
  rf: [
    { name: 'M200', time: '4:32:00', standard: RFSet2, heavy: HeavySet4141, unsure: [1, 1] },
    ...
    { name: 'IWS 2000', time: '4:52:00', standard: RFSet2, heavy: HeavySet4141 },
    { name: 'M99', time: '4:55:00', standard: RFSet2, heavy: HeavySet4141 },
    { name: 'Lee-Enfield', time: '5:00:00', standard: RFSet2, heavy: HeavySet4141 }
  ],
  mg: [
    { name: 'Type 88', time: '6:28:00', standard: MGSet2, heavy: HeavySet6613 },
  ...
  sg: [
    ...
    { name: 'Saiga-12', time: '8:05:00', heavy: HeavySet6164 },
    { name: 'FP-6', time: '8:06:00', heavy: HeavySet6164 },
    { name: 'S.A.T.8', time: '8:10:00', heavy: HeavySet6164 },
    { name: 'AA-12', time: '8:12:00', heavy: HeavySet6164 }
  ]
}
